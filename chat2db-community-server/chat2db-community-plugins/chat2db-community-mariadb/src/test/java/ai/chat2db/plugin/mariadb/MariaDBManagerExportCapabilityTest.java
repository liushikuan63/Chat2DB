 ...
 */
class MariaDBManagerExportCapabilityTest {

    @Test
    void declaresKeysetShardingExportCapability() {
        assertTrue(new MariaDBManager().getExportCapability().isKeysetSharding());
    }
    ...
    void startsConsistentSnapshotWithDialectOwnedStatements() throws Exception {
        ...
        assertTrue(new MariaDBManager().startConsistentExportSnapshot(connection));
